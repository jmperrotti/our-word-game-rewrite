        ...
        <div className="space-y-5">
          ...
          {!inviteCode && onShareInvite && (
            <button
              ...
              disabled={!hasUsername || isBusy}
              className="flex min-h-12 w-full items-center justify-center gap-2 rounded-xl bg-blue-600 py-3 font-semibold text-white transition hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-40"
            >
          ...
          <div className="flex flex-col gap-2 sm:grid sm:grid-cols-3 sm:gap-3">
            <button
              ...
              disabled={!hasUsername || isBusy}
              className="min-h-12 rounded-xl bg-zinc-900 py-3 font-semibold text-white transition hover:bg-zinc-800 disabled:cursor-not-allowed disabled:opacity-40"
            >
            ...
            <div className="flex flex-col gap-2 sm:grid sm:grid-cols-3 sm:gap-3">
              {BOT_OPTIONS.map((option) => (
                <button
                  ...
                  disabled={!hasUsername || isBusy}
                  className="min-h-12 rounded-xl border border-zinc-200 bg-white/60 px-3 py-3 text-center transition hover:bg-white disabled:cursor-not-allowed disabled:opacity-40"
                >
